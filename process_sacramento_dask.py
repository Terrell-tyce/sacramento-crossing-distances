...
class SacramentoProcessor:
    ...
    def __init__(self, coords_file='coordinates/sacramento_coords.csv', 
        ...
        cache_dir = Path(r"C:\Users\tenoru\Downloads")
    ...
    @delayed
    def process_intersection(self, idx, lon, lat, zoom=20):
        """
...
def main():
    ...
    parser.add_argument('--cache', type=str, default=r"M:\Intersection-Images\cache",
